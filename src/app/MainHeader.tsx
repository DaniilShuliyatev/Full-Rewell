  ...
  return (
    <header id="main" className="mx-auto w-full py-8 flex flex-col md:flex-row justify-between items-start md:items-center mt-20 scroll-m-20 px-2 sm:px-4 min-w-0 gap-6">
      <h1 className="text-3xl md:text-6xl font-bold text-left break-words text-white">
        <span className="text-[var(--accent)] font-extrabold">Full-Rewell</span> — фулфилмент, который <span className="text-[var(--accent)] font-extrabold">не подводит</span>.<br/>
        <span className="text-[var(--accent)] font-extrabold">Ваше спокойствие</span> — наша работа.<br/>
      </h1>
      <button
